...
import { PluginCommandItem } from './PluginCommandItem.js';
...
export interface SlashMenuProps {
  ...
  /** Optional hook before plugin command execution */
  onBeforeExecutePlugin?: (command: SlashCommandEntry) => void;
}
          ...
          {filteredPlugins.map((command) => {
            ...
            return (
              <PluginCommandItem
                ...
                onMouseEnter={() => onHover(index)}
                onBeforeExecute={
                  onBeforeExecutePlugin ? () => onBeforeExecutePlugin(command) : undefined
                }
              />
            );
          })}
